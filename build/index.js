...
class Welcome {
  ...
  meetLists(counter) {
    ...
    if (this.products[counter] !== undefined) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(parent).then(response => {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(route).then(response => {
      ...
      if (next) {
        next.addEventListener('click', e => {
          ...
          if (foot.dataset.id == '3') {
            ...
            axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(daportalData.ajax_url, formData).then(response => {
...
/* harmony import */ var _modules_Welcome__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/Welcome */ "./src/modules/Welcome.js");
/* harmony import */ var _modules_Burger__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/Burger */ "./src/modules/Burger.js");
...
const welcome = new _modules_Welcome__WEBPACK_IMPORTED_MODULE_4__["default"]();
const burger = new _modules_Burger__WEBPACK_IMPORTED_MODULE_5__["default"]();
})();
